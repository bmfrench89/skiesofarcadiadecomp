...
def script(seed: int, first: int = 3200, last: int = 33000) -> str:
    """The pad script, as one string. Deterministic in all three arguments."""
    state = seed
...
def main() -> int:
    ...
    a = p.parse_args()
    print(script(a.seed, a.first, a.last))
    return 0
