...
844 tests in 50 files, none of which reads the disc. The count you see depends
on what is installed, and the tool tells you: `825 passed, 1 skipped` without
capstone (what CI installs — the 19 cross-validation tests collapse into one
module-level skip), `613 passed, 231 skipped` without MSVC.
...
**0.11 s, 80 lines, 75 cases** — the cheapest real check in the project and the
