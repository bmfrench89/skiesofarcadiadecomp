...
651 tests in 41 files, none of which reads the disc. The count you see depends
on what is installed, and the tool tells you: `632 passed, 1 skipped` without
capstone (what CI installs — the 19 cross-validation tests collapse into one
module-level skip), `552 passed, 99 skipped` without MSVC.
